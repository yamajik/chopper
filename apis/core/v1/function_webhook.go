...
// +kubebuilder:webhook:path=/mutate-core-kess-io-v1-function,mutating=true,failurePolicy=fail,groups=core.kess.io,resources=functions,verbs=create;update,versions=v1,name=mfunction.kb.io,admissionReviewVersions=v1,sideEffects=None
...
func (r *Function) DefaultStatus() {
	functionlog.Info("default status", "name", r.Name)

	// TODO(user): fill in your defaulting logic.
}

// TODO(user): change verbs to "verbs=create;update;delete" if you want to enable deletion validation.
// +kubebuilder:webhook:verbs=create;update,path=/validate-core-kess-io-v1-function,mutating=false,failurePolicy=fail,groups=core.kess.io,resources=functions,versions=v1,name=vfunction.kb.io,admissionReviewVersions=v1,sideEffects=None
